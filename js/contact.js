...
(function () {
  ...
  function shootingStar() {
    ...
    /* travel distance measured from the page, not the viewport, so the
       streak always crosses the visible card */
  ...
  function saveButton() {
    ...
    /* sweeping light */
    /* wrap the button so the halo ring can pulse outside its clipped edge */
